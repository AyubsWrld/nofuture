    ...
    <header className="flex items-center justify-around gap-8 px-40 py-4 w-full bg-[#0b0b0b]">
      <nav className="inline-flex items-center gap-8 p-3 bg-[#141414] rounded-[20px] border border-solid border-[#2a2a2a]">
        <div className="inline-flex items-center gap-1 px-1 py-0">
          <ShoppingCartIcon className="w-[63px] h-[42.46px] text-white" />
        ...
        <Button className="inline-flex items-center justify-center gap-2 px-4 py-3.5 h-auto bg-[#0064e0] rounded-xl overflow-hidden border-t-2 [border-top-style:solid] border-[#0071ff] shadow-[0px_0px_0px_1px_#0050b2,inset_0px_-3px_0px_#004fb2] hover:bg-[#0064e0]/90">
