  ...
  return (
    <header className="flex items-center justify-around gap-8 px-40 py-4 w-full bg-[#0b0b0b]">
      <nav className="inline-flex items-center gap-8 p-3 bg-[#141414] rounded-[20px] border border-solid border-[#2a2a2a]">
        ...
        <Button className="h-auto px-4 py-3.5 bg-[#0064e0] rounded-xl border-t-2 [border-top-style:solid] border-[#0071ff] shadow-[0px_0px_0px_1px_#0050b2,inset_0px_-3px_0px_#004fb2] hover:bg-[#0064e0]/90">
          <span className="[text-shadow:0px_1px_3px_#0000001a] [font-family:'Inter_Tight',Helvetica] font-medium text-white text-sm text-center tracking-[0] leading-[21px] whitespace-nowrap">
            Cart
          </span>
        </Button>
      </nav>
